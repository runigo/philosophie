...
\ib{Factice} — \si{Hist.} {\bf 1.} Chez Descartes :
...
\ib{Facticité} — {\bf 1.} Caractère de ce qui
...
\ib{Faible} — \si{Psycho.} Dans la Gestaltpsychologie, une forme$^4$ est dite
faible quand elle est peu structurée,
quand les éléments sont peu intégrés au tout.

\ib{Fait} — \si{Épist.} Toute donnée de l’expérience$^1$ : « Un fait n'est rien par
...
\ib{Famille} — \si{Soc.} {\bf 1.} La société domestique*, comprenant tous ceux qui
...
\ib{Fantaisie} [G. phantasia, imagination].
...
\ib{Faustien} — \si{Hist.} Qualificatif appliqué
...
\ib{Fétichisme} — {\bf 1.} Culte des fétiches,
...
\ib{Fidéisme} — À, Théoi. {\bf 1.} Str, Doctrine
...
\ib{Figure} — \si{Math.} {\bf 1.} Étendue$^1$ limitée
...
\ib{Fin} — \si{Épist.} et \si{Méta.} {\bf 1.} ({\it Opp.} :
...
\ib{Final} — \si{Épist.} et \si{Méta.} {\bf 1.} Qui se
...
\ib{Finalisme} — \si{Méta.} À. Doctrine qui
...
\ib{Finalité} — \si{Épist.} et \si{Méta.} {\bf 1.} Caractère de ce qui tend vers une fin$^2$ de
...
\ib{Finesse (Esprit de)} — \si{Car.} Chez
...
\ib{Fixisme} — \si{Biol.} ({\it Opp.} : transformisme*)). À. Théorie de la fixité des
espèces, selon laquelle les espèces$^3$
vivantes demeurent immuables et
sont nettement distinctes les unes
des autres.

\ib{Fluctuation} — \si{Biol.} Variation quise produit chez un être vivant sous l’action
...
\ib{Fondement} — {\bf 1.} Principe sur lequel
...
\ib{Force} — \si{Vulg.} {\bf 1.} (Souvent {\it opp.}
...
\ib{Forme} — ({\it Gén.} {\it opp.} matière). \si{Hist.}
...
\ib{Formel} — \si{Hist.} Qui concerne la
...
\ib{Fortuit} — \si{Épist.} Qui relève du
...
\ib{Futur} — A venir. {\it Cf.} Contingenf$^2$.
