...
\ib{Sacré} —— Théol. 1. Qui inspire un
...
\ib{Sadisme} — Ps. an. Perversion qui
consiste à trouver le plaisir dans la
souffrance infligée à autrui.

\ib{Sagesse} — 1. Autref., savoir, science$^1$ :
...
\ib{Sainteté} — Mor. Perfection morale,
...
\ib{Salut} — Théol. Destinée bienheureuse des justes$^1$ : « Dieu veut le
salut de tous les hommes » (Malebranche).

\ib{Sanction} [L. sancire, consacrer]. —
...
\ib{Sceptique} — Hist. À. Qui professe
...
\ib{Schéma} — Techn. 1. Figure ou diagramme simplifié. — Psycho. 2. Chez
...
\ib{Schizoïdie} — Car. Orientation du
...
\ib{Science} — Épist. 1. Lato. Savoir en
...
\ib{Scientisme} — Épist. (Péj.) Conception déformée de la science$^2$ qui
...
\ib{Scolastique} — Hist. 1. Qui se rattache
...
\ib{Secondarité} — Car. (Opp. : primarité*). Trait de caractère$^3$ où domine
...
\ib{Ségrégation} — 1. Processus par lequel
...
\ib{Sélection} — 1. Processus par lequel,
...
\ib{Séminales (Raisons)} [Trad. G. : logospermatikoï]. — Hist. Notion d’origine stoïcienne, reprise, mais modifiée par Plotin, puis par St Augustin, et qui désigne les germes dans
lesquels auraient été préformés* dès
l’origine les êtres vivants.

\ib{Sens} — Psycho. 1. (Adj. correspondant : sensible$^2$ ou sensitif$^1$). Fonction psycho-physiologique qui consiste à éprouver une certaine classe
...
\ib{Sens commun} — Hist. 1. Chez les
...
\ib{Sensibilité} — M. Phol. 1. (Syn. : excitabilité ou irritabilité). Propriété des
...
\ib{Sensitif} — (Opp. : intellectuel, dans
...
\ib{Sensoriel} — Phol. Qui concerne les
sens$^4$ : « Les organes sensoriels. »

\ib{Sensorium} — Voir Sens commun.

\ib{Sensualisme} — Hist. À. Nom imppt.
...
\ib{Sensuel} — ©. 1. Attaché aux plaisirs
...
\ib{Sentiment} — Vulg. 1. Conscience$^1$ :
...
\ib{Série} — Épist. 1. Suite de termes
...
\ib{Sérieux} — ©. 1. Grave, qui ne plaisante pas : « Un homme qui n’a de
...
\ib{Seuil} — Phol., Psycho. Intensité minima d’un excitant nécessaire pour
...
\ib{Similitude} — Épist. 1. Ressemblance,
...
\ib{Simple} — Méta. 1. Indivisible; où l’on
...
\ib{Simplicité des voies} — Hist. Principe
...
\ib{Social} — 1. (Ctr. : individuel). Qui
...
\ib{Socialisme} — Soc. A. 1. (Sens primitif, »g. chez Pierre Leroux. Opp. :
...
\ib{Société} — O. 1. Latiss, Ensemble de
...
\ib{Sociodrame} — Soc. Sorte de psychodrame* qui s'adresse à un groupe
...
\ib{Sociométrie} — Soc. Forme de recherches sociologiques (ou plutôt interpsychologiques) créée par J. Moreno
...
\ib{Socius} — Soc. Terme introduit dans
...
\ib{Soi} — Ps. an. Autre nom du Çà*.

\ib{Solidarisme} — Mor. À. Doctrine qui
pose la solidarité$^4$ comme principe
de la morale, de la politique et de
l’économie sociale.

\ib{Solidarité} [L. solidus, massif, qui
...
\ib{Solipsisme} [L. solus ipse, seul moimême]. — Crit. Attitude philosophique qu'on a qgfs. donnée
...
\ib{Somnambulisme} —— Ps. path. État
dans lequel un sujet endormi exécute
des actes dont il ne garde aucun souvenir au réveil.

\ib{Sophisme} [de sophiste$^2$]. — Log. 1. Raisonnement captieux, paralogisme*
% 173
...
\ib{Sophistes} [G. sophia, sagesse]. — Hist.
...
\ib{Sorite} [G. sôros, tas]. — Log. form.
...
\ib{Souci} [Trad. all. Sorge]. — Méta. Chez
...
\ib{Souvenir} — Psycho. 1. Lato. Tout état
...
\ib{Spécial} — Log. Un terme général$^2$ est
...
\ib{Spécieux} — Épist. 1. Qui présente une
...
\ib{Spécificité} — Épist. 1. Caractère spécifique$^2$. — Phol. 2. Spécificité des
...
\ib{Spécifique} — Épist. 1. Qui concerne
...
\ib{Spéculatif} — 1. Qui concerne la spé
...
\ib{Spéculation} — 1. (Syn. : théorie$^1$, Opp. :
...
\ib{Spirituel} — Méta. 1. (Opp. : matériel).
...
\ib{Spontané} — 1. (Opp. : réceptif). Qui
...
\ib{Statique (adj.)} — 1. (Opp. : dynamique$^1$, mouvant). Qui a les caractères d’un état, d’un repos ou d’un
...
\ib{Statique (nom)} — Ébpist. 3. Partie
...
\ib{Statutaire (Droit)} — Jur. Celui qui
...
\ib{Stéréotypes} — Psycho. Soc. Images
...
\ib{Stochastique} [G. stochos,  conjecture]. — Épist. Se dit des phénomènes
% 176
...
\ib{Stratification} — Phys. 1. En Géologie,
...
\ib{Structure} — 1. O. Organisation des parties ou des éléments qui forment un
...
\ib{Subalternes (Propositions)} — Log. form. Propositions opposées* différant seulement en quantité$^2$ : vg.
...
\ib{Subconscient} — Psycho. 1. Faible
...
\ib{Subcontraires (Propositions)} — Log. form. Propositions opposées*, toutes
...
\ib{Subjectivisme} — A. À. Péj. Propen
...
\ib{Sublimation} — Ps. an. Processus par
...
\ib{Sublime} — Esth. Le beau, dans un
...
\ib{Subliminal} [L. sub, sous, et limen,
...
\ib{Substantialisme} — Hist. (Opp. : phénoménisme*). À. Doctrine qui admet
...
\ib{Substantialité} — Méta. Caractère substantiel$^1$ : « La substantialité du
...
\ib{Substantiel} — Méta. 1. Qui est une
...
\ib{Substrat, Substratum} —— Méta. 1. La
...
\ib{Subtil} — Voir Matière$^4$. Qqfs., nom :
« Cette corde peut donc ébranler
l’air qui l’environne, et même le
subtil qui en pénètre les pores ? »
(Malebranche, Entr., III, 10).

\ib{Suggestibilité} — Psycho. État de l’individu qui subit facilement des suggestions$^2$ (vg. l’hystérique).

\ib{Suggestion} — Ps. path. 1. Lato. « Il y
...
\ib{Sujet} — M. Vulg. 1. Ce sur quoi porte
...
\ib{Superstructure} — Soc. Voir Base$^2$ :
...
\ib{Suppôt} (L. suppositum, placé sous). —
...
\ib{Surdétermination} — Psycho. Une des
...
\ib{Surdité psychique} — Ps. path. Agnosie* auditive. — Surdité verbale. Cf.
Aphasie*.

\ib{Sur-moi} — Ps. an. (Syn. : moi idéal).
...
\ib{Surnaturel} — Théol. Ce qui dépasse
...
\ib{Surréalisme} — Esth. Forme de littérature et d'art qui prétend atteindre
...
\ib{Syncrétisme} — 1. A. Péj. « Réunion
...
\ib{Syndérèse} — Hist. Chez les Scolastiques : conscience$^3$ morale : « Saint
...
\ib{Synergie} [G. sun, avec, et ergon, travail]. — 1. Association dynamique
de plusieurs fonctions. — 2. Accord
des tendances.

\ib{Synesthésie} — Psycho. Fusion intime
...
\ib{Synthèse} — O. Épist. 1. (Opp. : analyse$^3$). Opération qui consiste à recomposer un tout à l’aide de ses
...
\ib{Synthétique} — 1. Qui se rapporte à
...
\ib{Systématique} — (Adj.). 1. Laud. Méthodiquement (et souvent consciemment) organisé : « La constitution
...
\ib{Système} — ®. 1. Ensemble organisé
