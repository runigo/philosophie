...
\ib{Sacré} — \si{Théol.} {\bf 1.} Qui inspire un
...
\ib{Sadisme} — \si{Ps. an.} Perversion qui
consiste à trouver le plaisir dans la
souffrance infligée à autrui.

\ib{Sagesse} — {\bf 1.} {\it Autref.}, savoir, science$^1$ :
...
\ib{Sainteté} — \si{Mor.} Perfection morale,
...
\ib{Salut} — \si{Théol.} Destinée bienheureuse des justes$^1$ : « Dieu veut le
salut de tous les hommes » (Malebranche).

\ib{Sanction} — [{\it L.} sancire, consacrer] —
...
\ib{Scepticisme} — [G. skeptomai, j'examine]
...
\ib{Sceptique} — \si{Hist.} À. Qui professe
...
\ib{Schéma} — \si{Techn.} {\bf 1.} Figure ou diagramme simplifié. — \si{Psycho.} {\bf 2.} Chez
...
\ib{Science} — \si{Épist.} {\bf 1.} {\it Lato.} Savoir en
...
\ib{Scientisme} — \si{Épist.} ({\it Péj.}) Conception déformée de la science$^2$ qui
...
\ib{Second, Secondaire} — Voir Premier$^4$,
Primaire* et Secondarité*.

\ib{Secondarité} — \si{Car.} ({\it Opp.} : primarité*). Trait de caractère$^3$ où domine
...
\ib{Ségrégation} — {\bf 1.} Processus par lequel
...
\ib{Sélection} — {\bf 1.} Processus par lequel,
...
\ib{Sémantème} — [G. sêmainein, signifier] —
...
\ib{Sémantique} — \si{Épist.} Partie de la
linguistique qui étudie les significations et l'évolution du sens des mots.
$->$ On a dit aussi séméiotique et
sémiologie.

\ib{Semences de vérité} — \si{Hist.} Expression employée par Descartes (Méth.,
...
\ib{Séminales (Raisons)} — [{\it Trad.} G. : logospermatikoï] — \si{Hist.} Notion d’origine stoïcienne, reprise, mais modifiée par Plotin, puis par St Augustin, et qui désigne les germes dans
lesquels auraient été préformés* dès
l’origine les êtres vivants.

\ib{Sens} — \si{Psycho.} {\bf 1.} ({\it Adj.} correspondant : sensible$^2$ ou sensitif$^1$). Fonction psycho-physiologique qui consiste à éprouver une certaine classe
...
\ib{Sens commun} — \si{Hist.} {\bf 1.} Chez les
...
\ib{Sensation} — \si{Psycho.} {\bf 1.} Fait de
...
\ib{Sensibilité} — M. \si{Phol.} {\bf 1.} (Syn. : excitabilité ou irritabilité). Propriété des
...
\ib{Sensible} — A) © Doué de sensibilité*
...
\ib{Sensitif} — ({\it Opp.} : intellectuel, dans
...
\ib{Sensorium} — Voir Sens commun.

\ib{Sensualisme} — \si{Hist.} À. Nom imppt.
...
\ib{Sensuel} — ©. {\bf 1.} Attaché aux plaisirs
...
\ib{Sentiment} — \si{Vulg.} {\bf 1.} Conscience$^1$ :
...
\ib{Série} — \si{Épist.} {\bf 1.} Suite de termes
...
\ib{Sérieux} — ©. {\bf 1.} Grave, qui ne plaisante pas : « Un homme qui n’a de
...
\ib{Seuil} — \si{Phol.}, \si{Psycho.} Intensité minima d’un excitant nécessaire pour
...
\ib{Similitude} — \si{Épist.} {\bf 1.} Ressemblance,
...
\ib{Simple} — \si{Méta.} {\bf 1.} Indivisible; où l’on
...
\ib{Simplicité des voies} — \si{Hist.} Principe
...
\ib{Singulier} — \si{Log.} Qui s'applique à un
...
\ib{Situation} — \si{Méta.} {\bf 1.} Une des catégories* d'Aristote : {\it p. e.} être couché
...
\ib{Social} — {\bf 1.} (Ctr. : individuel). Qui
...
\ib{Socialisme} — \si{Soc.} A. {\bf 1.} (Sens primitif, »g. chez Pierre Leroux. {\it Opp.} :
...
\ib{Société} — O. {\bf 1.} Latiss, Ensemble de
...
\ib{Sociologie} — Epist. Science positive
...
\ib{Sociométrie} — \si{Soc.} Forme de recherches sociologiques (ou plutôt interpsychologiques) créée par J. Moreno
...
\ib{Socius} — \si{Soc.} Terme introduit dans
...
\ib{Soi} — \si{Ps. an.} Autre nom du Çà*.

\ib{Solidarisme} — \si{Mor.} À. Doctrine qui
pose la solidarité$^4$ comme principe
de la morale, de la politique et de
l’économie sociale.

\ib{Solidarité} — [{\it L.} solidus, massif, qui
...
\ib{Solipsisme} — [{\it L.} solus ipse, seul moimême] — \si{Crit.} Attitude philosophique qu'on a qgfs. donnée
...
\ib{Somatique} — [G. sôma, corps] — Qui
concerne le corps$^3$.

\ib{Somnambulisme} — \si{Ps. path.} État
dans lequel un sujet endormi exécute
des actes dont il ne garde aucun souvenir au réveil.

\ib{Sophisme} — [de sophiste$^2$] — \si{Log.} {\bf 1.} Raisonnement captieux, paralogisme*
% 173
...
\ib{Sophistes} — [G. sophia, sagesse] — \si{Hist.}
...
\ib{Sorite} — [G. sôros, tas] — \si{Log.} \si{form.}
...
\ib{Sotériologie} — [G. sôtêr, sauveur] —
\si{Théol.} Doctrine du salut*.

\ib{Souci} — [{\it Trad.} all. Sorge] — \si{Méta.} Chez
...
\ib{Souvenir} — \si{Psycho.} {\bf 1.} {\it Lato.} Tout état
...
\ib{Spatial} — Qui a les caractères de
l’espace ou se localise dans l’espace :
« Les perceptions spatiales. »

\ib{Spécial} — \si{Log.} Un terme général$^2$ est
...
\ib{Spécieux} — \si{Épist.} {\bf 1.} Qui présente une
...
\ib{Spécificité} — \si{Épist.} {\bf 1.} Caractère spécifique$^2$. — \si{Phol.} {\bf 2.} Spécificité des
...
\ib{Spécifique} — \si{Épist.} {\bf 1.} Qui concerne
...
\ib{Spéculatif} — {\bf 1.} Qui concerne la spé
...
\ib{Spéculation} — {\bf 1.} (Syn. : théorie$^1$, {\it Opp.} :
...
\ib{Spiritisme} — Ensemble de pratiques
qui visent à entrer en communication avec les esprits$^4$ des
morts.

\ib{Spiritualisme} — \si{Méta.} À. {\bf 1.} ({\it Opp.} :
...
\ib{Spirituel} — \si{Méta.} {\bf 1.} ({\it Opp.} : matériel).
...
\ib{Spontané} — {\bf 1.} ({\it Opp.} : réceptif). Qui
...
\ib{Statique (adj.)} — {\bf 1.} ({\it Opp.} : dynamique$^1$, mouvant). Qui a les caractères d’un état, d’un repos ou d’un
...
\ib{Statutaire (Droit)} — \si{Jur.} Celui qui
...
\ib{Stéréotypes} — \si{Psycho.} \si{Soc.} Images
préconçues des choses et des êtres,
que se fait l'homme moyen d’un
certain milieu social (W. Lippmann).

\ib{Stimulus} — Voir Excitant*.

\ib{Stochastique} — [G. stochos, conjecture] — \si{Épist.} Se dit des phénomènes
% 176
...
\ib{Stratification} — \si{Phys.} {\bf 1.} En Géologie,
...
\ib{Structuration} — Organisation en
...
\ib{Structure} — {\bf 1.} O. Organisation des parties ou des éléments qui forment un
...
\ib{Subalternes (Propositions)} — \si{Log.} \si{form.} Propositions opposées* différant seulement en quantité$^2$ : {\it p. e.}
...
\ib{Subconscient} — \si{Psycho.} {\bf 1.} Faible
...
\ib{Subcontraires (Propositions)} — \si{Log.} \si{form.} Propositions opposées*, toutes
...
\ib{Subjectif} — \si{Crit.} et \si{Méta.} ({\it Opp.}
...
\ib{Subjectivisme} — A. À. {\it Péj.} Propen
...
\ib{Sublimation} — \si{Ps. an.} Processus par
...
\ib{Sublime} — \si{Esth.} Le beau, dans un
...
\ib{Substantialisme} — \si{Hist.} ({\it Opp.} : phénoménisme*). À. Doctrine qui admet
...
\ib{Substantialité} — \si{Méta.} Caractère substantiel$^1$ : « La substantialité du
...
\ib{Substantiel} — \si{Méta.} {\bf 1.} Qui est une
...
\ib{Subsumer} — Voir Subsomption*.

\ib{Subtil} — Voir Matière$^4$. {\it Qqfs.}, nom :
« Cette corde peut donc ébranler
l’air qui l’environne, et même le
subtil qui en pénètre les pores ? »
(Malebranche, {\it Entr.}, III, 10).

\ib{Suggestibilité} — \si{Psycho.} État de l’individu qui subit facilement des suggestions$^2$ ({\it p. e.} l’hystérique).

\ib{Suggestion} — \si{Ps. path.} {\bf 1.} {\it Lato.} « Il y
...
\ib{Sujet} — M. \si{Vulg.} {\bf 1.} Ce sur quoi porte
...
\ib{Superstructure} — \si{Soc.} Voir Base$^2$ :
...
\ib{Suppôt} — [{\it L.} suppositum, placé sous] —
...
\ib{Surdétermination} — \si{Psycho.} Une des
...
\ib{Surdité psychique} — \si{Ps. path.} Agnosie* auditive. — Surdité verbale. {\it Cf.}
Aphasie*.

\ib{Sur-moi} — \si{Ps. an.} (Syn. : moi idéal).
...
\ib{Surmonter} — Voir Aufheben*.

\ib{Surnaturel} — \si{Théol.} Ce qui dépasse
...
\ib{Symbolique} — Qui use de symboles*
...
\ib{Symptomatique (Acte)} — \si{Ps. an.}
...
\ib{Syncrétisme} — {\bf 1.} A. {\it Péj.} « Réunion
...
\ib{Syndérèse} — \si{Hist.} Chez les Scolastiques : conscience$^3$ morale : « Saint
...
\ib{Synergie} — [G. sun, avec, et ergon, travail] — {\bf 1.} Association dynamique
...
\ib{Synnomique} — [G. sun, avec, et nomos,
...
\ib{Synthèse} — O. \si{Épist.} {\bf 1.} ({\it Opp.} : analyse$^3$). Opération qui consiste à recomposer un tout à l’aide de ses
...
\ib{Synthétique} — {\bf 1.} Qui se rapporte à
...
\ib{Syntone} — Cor. (Syn. : extraverti). Qui
est en accord avec son entourage.

\ib{Systématique} — ({\it Adj.}). {\bf 1.} {\it Laud.} Méthodiquement (et souvent consciemment) organisé : « La constitution
...
\ib{Système} — ®. {\bf 1.} Ensemble organisé
