...
\ib{Magie} — \si{Hist.} {\bf 1.} Ensemble de pratiques occultes par lesquelles (surtout dans les sociétés primitives) on
...
\ib{Maître et esclave} — \si{Hist.} Chez Hegel :
...
\ib{Majeur} — \si{Log.} \si{form.} Dans un syllogisme : {\bf 1.} Grand* terme. — {\bf 2.} (Au
fém.). Majeure, prémisse* qui contient le majeur$^1$.

\ib{Mal} — \si{Méta.} et \si{Mor.} {\bf 1.} « Le mal
...
\ib{Malheur de la conscience} — \si{Hist.}
...
\ib{Mana} — \si{Soc.} Principe impersonnel
qui, dans les croyances des sociétés
primitives, donne l'efficacité à tout
ce qui agit.

\ib{Manichéisme} — A. \si{Hist.} {\bf 1.} Doctrine
...
\ib{Manie} — \si{Ps. path.} Surexcitation
...
\ib{Manqué (Acte)} — [{\it trad.} all. Fehlleisiung]
...
\ib{Marginalisme} — A. \si{Éc. pol.} Théorie
...
\ib{Masochisme} — \si{Ps. path.} Perversion
dans laquelle le sujet prend plaisir
à s'infliger des souffrances à luimême,

\ib{Matérialisme} — A (Ctr. : spiritualisme*). \si{Méta.} {\bf 1.} {\it Str.} Doctrine
...
\ib{Mathématiques} — \si{Épist.} Ensemble
...
\ib{Matière} — \si{Hist.} {\bf 1.} (Syn. : cause$^4$ matérielle. {\it Opp.} : forme$^1$). Chez Aristote
...
\ib{Matrice} — \si{Math.} Nombre complexe$^2$
...
\ib{Maxime} — \si{Vulg.} {\bf 1.} Proposition exprimant un précepte : « Les maximes
...
\ib{Mécanique (nom)} — \si{Épist.} — {\bf 1.} Science
...
\ib{Mécanique (adj.)} — \si{Vulg.} {\bf 3.} Qui concerne les machines : « Arts mécaniques ».
...
\ib{Mécanisme} — A \si{Vulg.} {\bf 1.} Combinai
...
\ib{Médiation} — \si{Vulg.} {\bf 1.} Action de
...
\ib{Médiatiser} — {\bf 1.} Rendre médiat*. —
...
\ib{Médium} — \si{Psycho.} Personne qui
...
\ib{Mélancolie} — \si{Psycho.} {\bf 1.} Tristesse
...
\ib{Même (Le)} — \si{Méta.} L'identique. {\it Cf.}
Autre$^2$ et Identité$^3$.

\ib{Mémoire} — \si{Biol.} et \si{Psycho.} À. {\it Lato.}
...
\ib{Mesure} — \si{Épist.} Rapport d’une
...
\ib{Métagéométrie} — \si{Épist.} Géométrie
de l'hyperespace* : « Les géométries
% 116
non-euclidiennes ne sont que des
cas particuliers de la métagéométrie » (Brunschvicg).

\ib{Métamorale} — \si{Mor.} « Dans nos systèmes de morale$^2$ théorique se trouvent souvent confondues des observations de faits, et des conceptions
...
\ib{Métaphysique (adj.)} — {\bf 8.} Qui relève
...
\ib{Métapsychique} — \si{Épist.} Étude des
phénomènes parapsychiques*.

\ib{Métempirique} — \si{Crit.} Qui, sans être
ppt. métaphysique$^8$, est cependant
au-delà de l'expérience sensible.

\ib{Métempsycose} — \si{Hist.} Doctrine ({\it p. e.}
...
\ib{Méthode} — \si{Épist.} O {\bf 1.} « Art de bien
...
\ib{Milieu} — \si{Biol.}, \si{Psycho.}, \si{Soc.} {\bf 1.} Ensemble des êtres et des phénomènes
...
\ib{Mineur} — \si{Log.} \si{form.} Dans un syllogisme : {\bf 1.} Petit* terme. — {\bf 2.} (Au
fém.). Mineure, prémisse* qui contient le mineur$^1$.

\ib{Minimum sensible} — Voir Seuil*.

\ib{Miracle} — \si{Théol.} : {\bf 1.} « Quelque chose
...
\ib{Misonéisme} — \si{Psycho.} Éloignement
...
\ib{Mnémonique} — \si{Psycho.} Qui concerne
la mémoire : « Les fonctions mnémoniques. »

\ib{Mnémotechnie} — \si{Psycho.} Procédés
artificiels destinés à faciliter le
rappel des souvenirs.

\ib{Mobiles} — \si{Psycho.} {\bf 1.} {\it Lato.} Tout ce
...
\ib{Mobilité sociale} — \si{Soc.} Aptitude
...
\ib{Modal} — \si{Épist.} {\bf 1.} Qui concerne les
...
\ib{Modalité} — \si{Crit.} Propriété qui affecte
...
\ib{Mode (masc.)} — \si{Méta.} {\bf 1.} (Syn. : modi
...
\ib{Mode (fém.)} — \si{Soc.} {\bf 4.} {\it Str.} Ensemble
...
\ib{Mœurs} — \si{Soc.} et \si{Mor.} {\bf 1.} Ensemble
...
\ib{Moi} — Le sujet*, considéré : {\bf 1.} \si{Psycho.}
...
\ib{Molaire} — \si{Biol.} Qui est le résultat
...
\ib{Monade} — [G. monas, unité] — \si{Hist.}
...
\ib{Monadisme} — \si{Hist.} A. Doctrine de
Leibniz sur les monades$^2$.
% 120

\ib{Mondain} — \si{Méta.} Qui concerne le
monde extérieur$^2$. $->$ On dit aussi :
intramondain ({\it opp.} extramondain*).

\ib{Monisme} — [G. monos, seul] — A, \si{Méta.}
...
\ib{Monogénisme} — \si{Biol.} À. Doctrine
...
\ib{Morale} — \si{Soc.}, \si{Psycho.} {\bf 1.} (Syn. :
...
\ib{Moralisme} — \si{Mor.} ({\it Gén.} péj.) Attitude morale : a) qui substitue « l’honnêteté de surface » à la vertu authentique : « La corruption de la morale,
...
\ib{Moralité} — \si{Soc.} et \si{Mor.} {\bf 1.} @. (Syn. :
...
\ib{Morphème} — \si{Ling.} Élément formatif
...
\ib{Moteur} — \si{Hist.} (nom). {\bf 1.} Chez Aristote : « premier moteur », Dieu en
...
\ib{Motif} — \si{Psycho.} Mobile$^1$ d'ordre intellectuel : « Le conflit des mobiles$^2$ et
des motifs ».

Motilité, Motricité\ib{} — \si{Ps. phol.} Faculté
de se mouvoir soi-même.

\ib{Mouvement} — {\it Str.} \si{Phys.} {\bf 1.} Changement de position dans l’espace en
...
\ib{Moyen} — \si{Vulg.} (nom). {\bf 1.} Ce qui sert
...
\ib{Mutation} — \si{Biol.} ({\it Opp.} fluctuation*). Transformation brusque d’un
...
\ib{Mysticisme} — \si{Psycho.} À. {\bf 1.} État
...
\ib{Mystique} — \si{Psycho.} {\bf 1.} Qui concerne
...
\ib{Mythomanie} — \si{Ps. path.} Tendance
