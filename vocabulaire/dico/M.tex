...
\ib{Mécanisme} — \fsb{S. posit.} \si{Vulg.} {\bf 1.} Combinaison d'organes en vue de la
...
\ib{Mémoire} — \si{Biol.} et \si{Psycho.} {\bf 1.} {\it Lato.} Persistance d’une
...
\ib{Monade} — [G. {\it monas}, unité] — \si{Hist.} {\bf 1.} {\it Chez Platon} :
...
\ib{Monisme} — [G. {\it monos}, seul] — \fsb{S. norma.} \si{Méta.} Nom générique des
...
\ib{Motilité, Motricité} — \si{Ps. phol.} Faculté de se mouvoir soi-même.
...
\ib{Mythe} — [G. {\it muthos}, récit ou parole] — \si{Soc.} {\bf 1.} « Récit
