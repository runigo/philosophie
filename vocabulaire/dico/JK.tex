...
\ib{Joie} — \si{Psycho.} ({\it Opp.} : {\it tristesse}). État affectif
...
\ib{Juste} — {\bf A)} (Ctr. {\it injuste}). \si{Mor.} 1. (En parlant des
...
— B) (Ctr. : {\it faux}). \si{Log.} {\bf 3.} \fsb{S. objec.} Vrai, légitime :
