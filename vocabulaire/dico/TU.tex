...
%183
\ib{Table} — \si{Épist.} {\bf 1.} Chez Bacon : « tables
...
\ib{Tabou} — [mot polynésien] — \si{Soc.}
...
\ib{Tact} — \si{Ps. phol.} {\bf 1.} Laito. Le sens du
...
\ib{Tactisme} — \si{Phol.} Mouvement de
...
\ib{Taxinomie ou Taxonomie} — \si{Épist.}
Ancien nom de la systématiques$^3$.

\ib{Technique (nom)} — {\bf 1.} Ensemble des
...
\ib{Technologie} — \si{Épist.} Étude des
...
\ib{Tèlé} — [mot grec — loin] — \si{Soc.} En
...
\ib{Téléologique} — \si{Méta.} Qui suppose de
...
\ib{Télépathie} — [G. têlé, loin, et pathos, sentiment] — \si{Psycho.} Communication
directe de la pensée à grande distance.

\ib{Témoignage} — \si{Épist.} {\it Str.} {\bf 1.} Attestation volontaire d’un fait par un
...
\ib{Tempérament} — \si{Car.} Ensemble des
...
\ib{Tendance} — \si{Psycho.} {\bf 1.} {\it Str.} Forme
...
\ib{Tension psychologique} — \si{Psycho.}
...
\ib{Terme} — \si{Log.} \si{form.} Concept$^1$ représenté pour son expression verbale :
...
\ib{Terminologie} — \si{Ling.} Ensemble des
termes spéciaux d’une science ou
d’un auteur.

\ib{Test} — [mot anglais = épreuve] \si{Psycho.}
...
\ib{Théisme} — \si{Méta.} ({\it Opp.} : athéisme* et
...
\ib{Thème} — {\bf 1.} Sujet de réflexion ou de
...
\ib{Théocratie} — \si{Pol.} Système politique
caractérisé par la domination de la
caste sacerdotale : « Les premiers
Incas établirent une théocratie »
(Voltaire).

\ib{Théodicée} — [G. theos, dieu, et diké, plaidoyer] — \si{Méta.} {\bf 1.} Chez Leibniz :
...
\ib{Théologie} — \si{Méta.} {\bf 1.} (Théologie naturelle ou rationnelle). Partie de la
...
\ib{Théologique} — {\bf 1.} Qui concerne la
...
\ib{Théorétique} — \si{Épist.} {\bf 1.} Qui concerne
...
\ib{Thétique} — \si{Hist.} {\bf 1.} Chez Fichte (cf.
...
\ib{Théurgie} — \si{Hist.} « Connaissance des
...
\ib{Tolérance} — \si{Mor.} Attitude qui consiste, « non à renoncer à ses convictions ou à s'abstenir de les manifester, mais à s’interdire tous moyens
% 187
violents, injurieux ou dolosifs pour
les propager » (Goblot).

\ib{Topologie} — \si{Épist.} (Syn. : analysis
...
\ib{Totalitaire} — {\bf 1.} Intégral, complet,
...
\ib{Totalitarisme} — \si{Pol.} Système poli
...
\ib{Totalité} — \si{Crit.} {\bf 1.} Une des catégories
...
\ib{Totem} — [mot algonquin] — \si{Soc.} Être
...
\ib{Toucher} — \si{Ps. phol.} Le « toucher »
...
\ib{Tradition} — \si{Soc.} Transmission par
...
\ib{Traditionalisme} — A. \si{Vulg.} {\bf 1.} Attachement à la tradition*, culte du
...
\ib{Transcendance, Transcendant} — \si{Vulg.} {\bf 1.}
...
\ib{Transcendantal} — (on écrit aussi {\bf Transcendental}) — \si{Hist.} {\bf 1.} Chez les Scolastiques : attribut très général qui
...
\ib{Transcendantalisme} — \si{Hist.} A. Doctrine philosophico-religieuse d’Emerson et de penseurs analogues : « Il
...
\ib{Transfert} — \si{Psycho.} {\bf 1.} Loi de trans
...
\ib{Transfini (Nombre)} — \si{Math.} Nombre
...
\ib{Transmigration des âmes} — \si{Hist.}
...
\ib{Transformisme} — \si{Biol.} (Ctr. : firisme*).
...
\ib{Transrationalisme} — \si{Hist.} Terme
...
\ib{Travail} — \si{Math.} {\bf 1.} En Mécanique :
...
\ib{Tribu} — \si{Soc.} Groupe de clans* possédant ses institutions propres, qqfs.
son culte, et pourvu d’un gouvernement distinct des gouvernés.

\ib{Tropes} — \si{Hist.} Arguments par lesquels les Sceptiques grecs prétendaient montrer l'impossibilité d’atteindre des vérités certaines. {\it Cf.}
...
\ib{Truisme} — [de l’angl. true, vrai] — \si{Log.}
Vérité banale et trop évidente pour
mériter d'être énoncée.

\ib{Tsédek} — [mot hébreu = juste] \si{Psycho.}
Test de jugement moral inventé
par H. Baruk.

\ib{Type} — \si{Méta.} {\bf 1.} Modèle idéal d’où
...
\ib{Ubiquité} — [{\it L.} ubique, partout] — \si{Méta.}
(Syn. omniprésence). Caractère de
l'être qui est partout présent
« L’ubiquité divine, »

\ib{Ultra-choses} — \si{Psycho.} Chez Wallon :
objets qui « dépassent les données
sensibles », {\it p. e.} les origines, la vie, la
mort, le ciel.

\ib{Un (L')} — \si{Hist.} Chez Plotin : l'hypostase* la plus élevée d’où procèdent*
...
\ib{Unité} — O {\bf 1.} Caractère de ce quiest un,
...
\ib{Univers} — {\bf 1.} Tout ce qui existe dans
...
\ib{Universaux} — \si{Hist.} Chez les Scolas
...
\ib{Universel} — \si{Vulg.} {\bf 1.} Qui concerne
...
\ib{Univoque} — \si{Log.} Qui s'applique avec
