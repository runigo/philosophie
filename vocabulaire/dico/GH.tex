...
\ib{Génétique} — ({\it Adj.}) \si{Épist.} Qui retrace : {\bf 1.} la genèse réelle :
...
\ib{Grand terme} — \si{Log.} \si{form.} Dans un syllogisme (syn. :
...
\ib{Héraclitéisme} — \si{Hist.} \fsb{S. norma.} {\bf 1.} Doctrine du philosophe grec
...
\ib{Holisme} [G. {\it holos}, total]. — \fsb{S. norma.} \si{Méta.} {\bf 1.} Terme
...
\ib{Hylètique} — ({\it Adj.}) [Opp. : {\it éïdétique}$^1$]. {\bf 1.} Qui concerne
