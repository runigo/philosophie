...
\ib{Nappe} — \si{Biol.} « Unité de masse évo
lutive » (Teilhard de Chardin).

\ib{Narcissisme} — \si{Ps. an.} État mental
dans lequel la libido$^2$ est dirigée
uniquement vers le moi.

\ib{Narcoanalyse} — \si{Ps. phol.} Mode
...
\ib{Natalité} — \si{Soc.} Rapport du nombre
des naissances au chiffre de la
population pendant une période
donnée.

\ib{Nation} — \si{Soc.} {\bf 1.} Groupe social déterminé à la fois par certaines conditions naturelles et objectives (unité
...
\ib{Nationalisme} — \si{Soc.} et \si{Mor.} À, A.
...
\ib{Nationalité} — \si{Soc.} et \si{Pol.} O {\bf 1.} Carac
...
\ib{Naturalisme} — A. \si{Méta.} {\bf 1.} Doctrine
...
\ib{Naturante (Nature)} — \si{Hist.} Expression scolastique reprise par Spinoza
...
\ib{Nature} — \si{Méta.} A) Nature d'un
...
\ib{Nature (État de)} — \si{Pol.} ({\it Opp.}
...
\ib{Naturel} — {\bf 1.} Qui se rapporte ou qui
...
\ib{Naturisme} — \si{Soc.} À. {\bf 1.} Théorie selon
...
\ib{Néant} — \si{Méta.} {\bf 1.} Le non-être ; ce qui
...
\ib{Négatif} — {\bf 1.} Qui implique une négation* : « Le négatif possède une
...
\ib{Négation} — \si{Log.} (Ctr. : affirmation).
...
\ib{Négativité} — \si{Méta.} Chez Hegel : activité de la négation$^1$ comme moment
dialectique$^5$.
% 126
...
\ib{Névrose} — \si{Ps. path.} Maladie (telle
...
\ib{Nier} — \si{Psycho.} Poser un rapport
...
\ib{Nihilisme} — [{\it L.} nihil, rien] — A. Doctrine qui nie : {\bf 1.} \si{Crit.} l’existence de
...
\ib{Noématique} — \si{Crit.} Qui concerne le
noème : « Le sens noématique. »

\ib{Noème, Noèse} — \si{Crit.} Chez Husserl :
...
\ib{Noétique} — \si{Crit.} 4, Chez Husserl : qui
...
\ib{Nolonté} — \si{Psycho.} Résistance de la
...
\ib{Nominale (Définition)} — \si{Log.} Celle
qui consiste à définir un mot par
convention ({\it opp.} : définition réelle$^2$)

\ib{Nominalisme} — A. \si{Méta.}, \si{Psycho.} {\bf 1.}
...
\ib{Noocentrisme} — \si{Crit.} A. Doctrine ou
attitude gnoséologique* « qui fait
graviter l’être autour du connaître»
(Blanché).

\ib{Noologiques (Sciences)} — \si{Épist.} Chez
Ampère : les sciences de l'esprit.

\ib{Noosphère} — \si{Biol.} et \si{Méta.} « C'est
...
\ib{Normatif} — \si{Épist.} ({\it Opp.} : constatif*)
...
\ib{Norme} — [{\it L.} norma, règle] — \si{Épist.}
...
\ib{Notion} — \si{Vulg.} {\bf 1.} Connaissance, discernement : « Quelle notion Précise
...
\ib{Numineux} — [{\it L.} numen, divinité] —
...
\ib{O} — \si{Log.} \si{form.} Désigne les propositions particulières* négatives : {\it p. e.}
« Certains hommes ne sont pas instruits. »

\ib{Objectal} — \si{Ps. an.} Voir Libido$^2$.

\ib{Objectif} — \si{Crit.} et \si{Méta.} {\bf 1.} {\it Autref.}
...
\ib{Objectivation} — \si{Psycho.} {\bf 1.} Processus
...
\ib{Objet} — [{\it L.} ob-jectum, ce qui est placé
...
\ib{Obligation} — {\bf 1.} \si{Mor.} O. Caractère
...
\ib{Observation} — ©. \si{Épist.} {\bf 1.} {\it Lato.} Con
...
\ib{Obsession} — \si{Ps. path.} Image ou idée
...
\ib{Occasionalisme} — \si{Hist.} À. Doctrine
des causes occasionnelles* (chez
Geulincx, Malebranche, etc.).

\ib{Occasionnelle (Cause)} — \si{Méta.} Celle
...
\ib{Œdipe (Complexe d’)} — \si{Ps. an.} Chez
...
\ib{Olfactif} — \si{Ps. phol.} Qui se rapporte
à l’odorat.

\ib{Oligarchie} — \si{Pol.} Système politique
où le pouvoir, exercé par un petit
nombre de personnes, est exploité
par elles dans leur intérêt.

\ib{On} — [{\it Trad.} all. : man] — \si{Méta.} Chez
...
\ib{Onirique} — [G. onar, rêve] — \si{Psycho.}
...
\ib{Ontique} — [G. ôn, ontos, étant] — \si{Méta.}
Chez Heidegger : qui concerne l’existence quotidienne du Dasein$^2$; existentiel ({\it opp.} : ontologique*).

\ib{Ontogénie} — \si{Biol.} ({\it Opp.} : phylogénie*). Evolution biologique de
l’être individuel.

\ib{Ontologie} — \si{Méta.} Autre nom de la
...
\ib{Ontologique} — \si{Méta.} Qui concerne
...
\ib{Opérationnel, Opératoire} — \si{Épist.}
...
\ib{Opinion} — \si{Psycho.} et \si{Crit.} {\bf 1.} ©
...
\ib{Opposition} — \si{Log.} \si{form.} Mode de
...
\ib{Option} — \si{Mor.} et \si{Pol.} Choix$^1$ ; prise
de position : « L'option se dévoile :
être des hommes ou être des riches »
(Perroux).
% 132

\ib{Optimisme} — \si{Vulg.} À. © {\bf 1.} Disposition
...
\ib{Ordre} — \si{Épist.} {\bf 1.} (Sens général). Une
...
\ib{Organicisme} — A. \si{Biol.} {\bf 1.} ({\it Opp.} :
...
\ib{Organique} — \si{Biol.} {\bf 1.} Vie organique :
...
\ib{Organisé} — {\it Cf.} Diffus*.

\ib{Orientation} — \si{Ps. phol.} {\bf 1.} Sens de
...
\ib{Orthogénèse} — \si{Biol.} Évolution qui
