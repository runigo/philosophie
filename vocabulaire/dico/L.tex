...
\ib{Lacunaire} — \si{Ps. path.} {\bf 1.} Malade présentant des lésions
...
\ib{Lallation} (Syn. : {\it babillage}). — \si{Psycho.} Sorte de pré-langage,
où le tout jeune enfant commence à émettre des sons semi-articulés sans
signification ; il précède le {\it gazouillis}*.

\ib{Langage} — {\bf 1.} {\it Lato.} Tout système de signes$^4$ : « Le langage
...
\ib{Latent} — \si{Ps. an.} {\it Chez Freud} : le « contenu latent » du rêve
est sa signification profonde, masquée par le « contenu manifeste », {\it i.
e.} par les images qui la symbolisent.

\ib{Lattice} [mot anglais = {\it treillis, réseau}] — \si{Log.} Système
...
\ib{Laxisme} — \si{Théol.} \fsb{S. norma.} Doctrine impliquant une morale$^3$
relâchée, trop indulgente.

\ib{Légalité} — \si{Jur.} {\bf 1.} (Sens usuel). Conformité aux lois$^1$
...
\ib{Lexis} — \si{Log.} Simple énoncé d’un contenu intellectuel sans
assertion*.

\ib{Libéralisme} — \si{Vulg.} \fsb{S. posit.} {\bf 1.} Attitude générale de
tolérance$^2$ et de respect de l'indépendance d’autrui.

— \si{Pol.} \fsb{S. norma.} {\bf 2.} Doctrine qui préconise la liberté$^3$
...
— \si{Éc. pol.} \fsb{S. norma.} {\bf 4.} Doctrine qui préconise la liberté du
travail$^2$ et des échanges et la non-intervention de l'État en matière
économique.

\ib{Libertaire} — \si{Pol.} Partisan de l’anarchisme$^2$. $->$ {\it  Dist.}
libéral.

\ib{Liberté} — {\bf A)} \si{Soc.} et \si{Pol.} « La Liberté
...
\ib{Libido} (mot latin = {\it plaisir}). — Ps. an. {\it Chez Freud} : {\bf 1.}
...
\ib{Lieu} — \si{Méta.} {\bf 1.} Situation qu’occupe un corps dans l’espace :
...
\ib{Lignée} — \si{Biol.} Suite des individus$^1$ de même espèce$^3$ dérivant
des mêmes géniteurs. $->$ Dist. {\it phylum}*.

\ib{Limitatif} — {\it Chez Kant} : {\bf 1.} « Jugement limitatif » (syn. :
...
\ib{Limite} — \si{Vulg.} {\bf 1.} Ce qui borne une portion d’espace ou de temps, l’exercice d’un pouvoir, etc. : « Les limites de la connaissance ».
...
\ib{Linguistique} — \si{Épist.} Étude générale et comparée des langues,
visant à déterminer les lois de leur évolution.  $->$ Dist. {\it philologie}*.

\ib{Localisation} — \si{Psycho.} Opération par laquelle nous rapportons :
...
— \si{Psycho.} \fsb{S. posit.} {\bf 3.} Pensée logique$^7$, raisonnement, que
...
\ib{Logique (adj)} — {\bf 7.} (Syn. : {\it intellectuel}$^2$). Qui se
...
\ib{Logistique} — \si{Épist.} {\bf 1.} Chez les Grecs : art du calcul,
{\it opp.} à l’arithmétique théorique. — {\bf 2.} {\it Auj.}, Logique$^2$
mise sous forme d’algorithme*.

\ib{Logos} — [mot grec, qui signifie à la fois {\it parole} et {\it raison}]
...
\ib{Loi} — \si{Jur.} {\bf 1.} (Loi positive$^4$). Règle impérative promulguée
...
\ib{Ludique} — \si{Psycho.} Qui concerne le jeu : « La pensée ludique ».

\ib{Lumière naturelle} — \si{Méta.} La raison en tant qu’elle procède de Dieu
...
\ib{Lumières (Philosophie des)} — [{\it Trad.} all. {\it Aufklärung}] —
...
\ib{Lycée} — \si{Hist.} École philosophique d’Aristote.
