...
\ib{Lallation} (Syn. : babillage). — Psycho.
...
\ib{Langage} — 1. Laio. Tout système de
...
\ib{Laxisme} — Théol. À. Doctrine impliquant une morale$^3$ relâchée, trop
indulgente.

\ib{Légalité} — Jur. 1. (Sens usuel). Conformité aux lois$^1$ positives : « Comme
...
\ib{Lexis} — Log. Simple énoncé d’un
contenu intellectuel sans assertion*.

\ib{Libéralisme} — Vulg. A. 1. Attitude
...
\ib{Libertaire} — Pol. Partisan de l’anarchisme$^2$. $->$ Dist. libéral.

\ib{Liberté} — A) Soc. et Pol. « La Hberté
...
\ib{Lieu} — Méta. 1. Situation qu’occupe
...
\ib{Lignée} — Biol. Suite des individus$^1$
de même espèce$^3$ dérivant des
mêmes géniteurs. $->$ Dist. phylum*.

\ib{Limitatif} — Chez Kant : 1. « Jugement limitatif » (syn. : « indéfini ») :
...
\ib{Limite} — Vulg. 1. Ce qui borne une
...
\ib{Linguistique} — Épist. Étude générale
...
\ib{Logicisme} — Épist. A. Doctrine qui
...
\ib{Logique (nom)} — Vulg. 1. Enchaîne
...
\ib{Logique (adj)} — 7. (Syn. : intellectuel$^2$). Qui se rapporte à l’entendement$^3$ : « Les opérations logiques ».
— 8. (Souvent opp. psychologique).
Qui se rapporte à la Logique$^2$. — 9,
(Ctr. : illogique). Laud. Conforme
aux règles de la Logique$^2$.

\ib{Logistique} — Épist. 1. Chez les Grecs :
...
\ib{Loi} — Jur. 1. (Loi positive$^4$). Règle
...
\ib{Ludique} — Psycho. Qui concerne le
jeu : « La pensée ludique ».

\ib{Lumière naturelle} — Méta. La raison
...
\ib{Lumières} (Philosophie des) [Trad.
...
\ib{Lycée} — Hist. École philosophique
d’Aristote.
