...
\ib{Immanence} — Méta, {\bf 1.} Caractère de ce qui est immanent$^2$.
...
\ib{Immanentisme} — A. \si{Méta.} {\bf 1.} Doctrine qui considère l’Absolu ou
...
\ib{Indétermination} — \si{Log.} et \si{Méta.} 1. Absence de détermination$^1$
...
— \fsb{S. norma.} \si{Mor.} 3 Doctrine morale, selon laquelle l’homme a sa
...
\ib{Intégral (Calcul)} — \si{Math.} Partie du caleul infinitésimal* où l’on
élimine
%100
...
\ib{Intelligible} — \si{Psycho.} et Meta. {\bf 1.} ({\it Opp.} :
...
\ib{Introjection} — \si{Ps. an.} ({\it Opp.} : {\it projection}*) Phénomène
...
\ib{Introversion} — \si{Ps. an.} ({\it Opp.} : {\it extraversion}*).
...
\ib{Intuitif} — \si{Psycho.} et \si{Crit.} I {\bf 1.} Qui a les caractères ou
...
\si{Méta.} {\it A)} \fsb{S. abstr.} Connaissance immédiate* d’un objet de
