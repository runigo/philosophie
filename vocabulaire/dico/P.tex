...
\fsb{S. norma.} {\bf 1.} (Opp. : {\it athéisme}* et {\it théisme}*).
...
\ib{Paresseux (Argument)} — Raisonnement des fatalistes qui concluent de
leur doctrine à l’inutilité de l'effort (Leibniz, {\it Théod.}, préf.).

\ib{Parfait} — [L. {\it per-fectus}, achevé] — \si{Vulg.} {\bf 1.} (Souvent,
...
\ib{Pattern} — Mot anglais qqfs employé comme syn. de type, {\it not.} en
...
\ib{Persévération} — \si{Ps. path.} Sorte d'inertie ou d’ « enlisement » mental
...
\ib{Personnalité, Personne} — \si{Psycho.} {\bf 1.} Forme que prend la vie
...
\ib{Phylum} — \si{Biol.} Série d'espèces dérivant les unes des autres ou
...
\ib{Pluralisme} — \si{Méta.} (Opp. : {\it monisme}*). Nom générique des
...
\ib{Pneumatique, Pneumatologie} — [G. {\it pneuma}, esprit] — \si{Hist.} Nom donné
...
\ib{Positivisme} — \si{Hist.} \fsb{S. norma.} {\bf 1.} {\it Str.} Doctrine d'Aug. Comte. —
...
— \si{Vulg.} \fsb{S. posit.} {\bf 4.} Souci de se tenir aussi près que possible de la
réalité : « Envisager les choses avec positivisme. »

\ib{Possibilité, Possible} — \si{Méta.} {\it Dist.} : {\bf 1.} la possibilité {\it
...
\ib{Potentiel} — \si{Méta.} {\bf 1.} (Syn. : {\it virtuel} ; ctr. : {\it actuel}$^2$). Qui existe en puissance$^2$ : « Le temps appartient à ce type de réalités potentielles... » (Guitton).
...
\ib{Prélogique} — \si{Soc.} Qualificatif attribué par L. Lévy-Bruhl,
...
\ib{Premier} — Qui n’est précédé par rien : {\bf 1.} dans l’ordre chronologique
...
\ib{Primarité} — \si{Car.} (Opp. : {\it secondarité}*). Trait de
...
\ib{Probabilisme} — \si{Hist.} \fsb{S. norma.} {\bf 1.} Doctrine selon laquelle il n’y a
...
\ib{Problématique (Jugement)} — \si{Crit.} {\it Chez Kant} (opp. :
...
\ib{Psychothérapie} — \si{Méd.} « Médecine psychologique » (Janet),
