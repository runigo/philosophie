...
\ib{Paléontologie} — Épist. Étude des
...
\ib{Parallélisme} — Psycho. À. Théorie
...
\ib{Paramnésie} — Ps. path. (Syn. : illusion du déjà-vu). Trouble de la perception caractérisé par le sentiment
qu’on a déjà vécu un état de conscience global qui est en réalité
nouveau. $->$ Dist. pseudomnésie*.

\ib{Paranoïa} — Ps. path. Délire d’interprétation*.

Paraphasie. — Ps. path. Trouble du
langage dans lequel les mots sont
employés les uns pour les autres.

\ib{Paraphrénie} — Ps. path. Délire chronique qui prend souvent une forme
extravagante et fantastique.

\ib{Parapsychique} — Psycho. Qualifie les
...
\ib{Parenthèses (Mise entre)} — Méta.
...
\ib{Parfait} [L. per-fectus, achevé]. — Vulg.
...
\ib{Pari (Argument du)} — Hist. Celui
...
\ib{Par soi} — Méta. Est « par soi » l'être
...
\ib{Parti} — Math. 1. Règle des partis,
...
\ib{Participation} — Hist. 1. Chez Platon,
...
\ib{Particulier} — Vulg. 1. Syn. soit de
...
\ib{Patient} — Cf. Agent* et Intellect$^2$.

\ib{Patron} — Méta. Modèle, type idéal :
...
\ib{Péché} — Mor. Faute* morale considérée
...
\ib{Pédagogie} — Épist. Système ou
théorie de l’éducation.

\ib{Pédologie} — Épist. 1. [G. pedon, sol].
...
\ib{Percentilage} — Ps. métr. Méthode
d’étalonnage* des tests (cf. Précis,
Ph. II, p. 225; Sc. et M., p. 334).

\ib{Perception} — Psycho. O. 1. Fonction
...
\ib{Périphérique} — Phol. 1. L’extrémité
...
\ib{Persécution (Délire de)} — Ps. path.
...
\ib{Personnage} — Psycho. L'homme défini par son rôle social : « La nature
...
\ib{Perspectivisme} — Hist. À. 1. Doctrine
...
\ib{Persuader} — Psycho. Faire accepter
...
\ib{Petit} — Psycho. 1. Chez Malebranche :
...
\ib{Pétition de principe} — Log. Paralogisme* où l’on prend pour principe$^1$
ce qu'il s’agit de démontrer,

\ib{Phantasme} — Psycho. Représentation imaginaire qui se produit dans
certains états névropathiques.
$->$ Dist. hallucination*.

\ib{Phénoménal} — Crit. Chez Kant : qui
...
\ib{Philologie} — Épist. Étude spéciale d’une
langue. $->$ Dist. linguistique*.

\ib{Philosophie} — Vulg. 1. Conception
...
\ib{Phobie} — Ps. path. Crainte obsédante
et angoissante qui s'attache sans
raison à un objet déterminé (not.
dans la psychasthénie).

\ib{Phonation} — Phol. Fonction physiologique du langage articulé.
% 140

\ib{Phonème} — Ling. Élément sonore du
langage, son significatif : « Un phonème distinct est l'articulation qui
peut servir à distinguer un sens »
(Cohen).

\ib{Phonétique} — Épist. Science de la
phonation*. $->$ Dist. phonologie*.

\ib{Phonologie} — Ling. Partie de la linguistique* qui étudie les phonèmes.

\ib{Phosphène} — Phol. Impression lumineuse produite par une pression du
globe oculaire.

\ib{Phrénologie} — Hist. A. Théorie (de
...
\ib{Phylétique} — Biol. Qui concerne les
phyla* : « Évolution phylétique ».

\ib{Phylogénie} — Biol. (Opp. : ontogénie*). Évolution du phylum*
« L’ontogénie* reproduit la phylogénie » (loi biogénétique*, auj. contestée).

\ib{Phylum} — Biol. Série d'espèces dérivant Jes unes des autres ou liées les
unes aux autres « Le phylum
humain n’est pas un phylum comme
les autres » (Teilhard de Chardin).

\ib{Physicalisme} — Épist. À. Doctrine de
...
\ib{Physiologie} — Épist. Science des
fonctions$^2$ des organismes vivants.

\ib{Physique (adj.)} — 1. (Opp. : rationnel$^2$
...
\ib{Plébiscite} — Pol. Consultation du
...
\ib{Pluralisme} — Méta. (Opp. : monisme*).
...
\ib{Pneumatisme} —— Hist. Ancien nom
...
\ib{Polysyllogisme} — Log. form. Ensemble de plusieurs syllogismes
...
\ib{Polythéisme} — Soc. Système religieux qui admet une pluralité de
dieux (vg. paganisme ancien).

\ib{Polyvalentes (Logiques)} — Log. Celles
...
\ib{Position (Géométrie de)} — Épist.
Syn. de Topologie*.
% 143

\ib{Positionnel} — Voir Thétique*.

\ib{Positivisme} — Hist. À. 1. Str. Doctrine d'Aug. Comte. — 2. Lato.
...
\ib{Possibilité, Possible} — Méta. Dist. :
...
\ib{Postulat} — Épist. Proposition qui
...
\ib{Pour-soi} — Méta. 1. Chez Hegel : l'être,
...
\ib{Pouvoir} — Phys. 1. Propriété physique, force$^3$ : « Pouvoir absorbant » ;
...
\ib{Précision} — Épist. 1. S’est dit autref.
...
\ib{Pré-conscient} — Ps. an. Chez Freud :
partie de l'inconscient qui est « capable de devenir consciente ».

\ib{Prédestination} — Théol. Décret divin
...
\ib{Prédicat} [L. prædicare, attribuer].
...
\ib{Prédicatif (Jugement)} — Log. form.
...
\ib{Préférence} — Mor. 1. Chez Scheler :
...
\ib{Préformation} — Biol. À. (Syn. : emboîtement des germes. Opp. : épigénèse). Théorie (auj. abandonnée)
...
\ib{Prégnant} — Vulg. Significatif, expres
...
\ib{Préjugé} — Crit. Opinion$^3$ admise sans
...
\ib{Prélèvement} — Épist. Chez Lalande
...
\ib{Prélogique} — Soc. Qualificatif attri
...
\ib{Prémisses} — Log. form. Dans un syllogisme les deux propositions principes$^1$ : majeure* et mineure*.

\ib{Prémonition} — Psycho. Pensée,
rève, etc., qui semble nous annoncer
l'avenir.

\ib{Prémotion physique} — Théol. Action
par laquelle, selon certains théologiens, Dieu agirait directement sur
la volonté humaine tout en la laissant libre.

\ib{Préoccupation} [Trad. all. Besorgen].
— Méta. Chez Heidegger : caractère
fondamental du Dasein$^2$, qui résulte
du fait qu'il est lié au monde.

\ib{Préperception} — Psycho. Représentation anticipée d’un objet : « Nulle
...
\ib{Prescience} — Théol. Attribut de Dieu
qui lui permet de connaître l’avenir
ou plutôt de tout voir dans « un
éternel présent ».

\ib{Présence} —— Hist. 1. Chez Plotin : ce
...
\ib{Preuve} — Épist. Ce qui amène notre
...
\ib{Privatif} — Log. 1. Terme privatif :
...
\ib{Probabilisme} — Hist. À. 1. Doctrine
...
\ib{Probabilité} — Épist. 1. ©. Caractère
...
\ib{Probable} — Autref., 1. digne d'être
...
\ib{Problématique (Jugement)} — Crit.
...
\ib{Procession} — Hist. 1. Chez Plotin :
...
\ib{Profil psychologique} — Ps. métr. Graphique figurant les diverses aptitudes d’un sujet. Cf. Précis, Ph. IT,
p. 226 ; Sc. et M., p. 335.

\ib{Profit} — Éc. pol. Bénéfice propre de
l'entrepreneur ou du commerçant,
distinct de la rémunération du travail de direction.

\ib{Profond, Profondeur} — Psycho. Ces
...
\ib{Progrès} — À. 1. Développement (sans
...
\ib{Providence} — Méta. et Théol. Action
...
\ib{Providentialisme} — Méta. À. Doctrine qui consiste à tout expliquer
dans l’univers par l'intervention de
la Providence*.

\ib{Prudence} — Mor. 1. (Syn. : sagesse$^2$)
...
\ib{Pseudomnésie} — Psycho. Erreur de
...
\ib{Psittacisme} [L. psittacus, perroquet].
...
\ib{Psychanalyse} — Épist. Méthode thérapeutique, puis système psychologique, inaugurés par Freud, continués avec des variantes par Adler,
...
\ib{Psychè} — Ps. an. « Ensemble de tous
...
\ib{Psychologique} — 1. Qui concerne la
...
\ib{Psychométrie} — Épist. Étude quantitative des faits psychiques$^1$, au
point de vue de leur intensité*, de
leur durée$^1$, etc.

\ib{Psychopathie} — Ps. path. État psychique morbide, maladie mentale.

\ib{Psycho-physiologie} — Épist. Étude
des rapports entre les faits psychiques et les faits physiologiques.

\ib{Psychophysique} — Épist. 1. Étude
...
\ib{Psychose} — Ps. path. Maladie mentale
...
\ib{Psychotechnique} — Techn. Étude
...
\ib{Psychothérapie} — Méd. « Médecine
...
\ib{Public} — 1. (Adj.) Qui concerne l’ensemble des citoyens. Spéc., Jur.
...
\ib{Puérilisme} — Ps. path. Retour aux
...
\ib{Puissance} — Vulg. 1. Possibilité,
...
\ib{Pyrrhonisme} — Hist. À. 1. Doctrine
...
\ib{Pythagorisme} — Hist. À. 1. Doctrine
