...
\ib{Vitalisme} — \fsb{S. norma.} \si{Biol.} {\bf 1.} ({\it Opp.} : {\it animisme}$^2$ et
...
—— \si{Car.} {\bf 3.} \fsb{S. subje.} Qualité morale consistant dans l'énergie de la
...
\ib{Zététique} — [G. {\it zêtein}, chercher] — \si{Hist.} {\bf 1.} Qualificatif
