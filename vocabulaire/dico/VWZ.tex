...
\ib{Valeur}. — Vulg. 1. Vaillance, courage
...
\ib{Variable} — Math. et Log. Terme qui,
...
\ib{Vecteur} — Math. Segment orienté,
...
\ib{Végétative (Vie)} — Biol. (Opp. : rela
tion$^5$). Ensemble des fonctions$^2$ vitales communes aux végétaux et
aux animaux.

\ib{Velléité} — Psycho. Volition ébauchée,
...
\ib{Verbalisme} — (Péj.) Tendance à se
satisfaire de mots creux au lieu
d'idées. Cf. Psittacisme*.

\ib{Verbe} — 1. Parole : « La puissance
...
\ib{Vérifier} — Épist. 1. (En parlant du
...
\ib{Vérité} — Crit. et Épist. 1. O. Caractère de ce qui est vrai*. $->$ On
...
\ib{Vertu} — 1. Autref. puissance, pouvoir : « La vertu de tout un aimant
...
\ib{Vice} — Lato. 1. Défaut : « Le vice d’un
...
\ib{Vide} — Méta. 1. Absence de toute
...
\ib{Vigilance} — Méta. Chez Heidegger :
...
\ib{Virtuel} — Méta. (Ctr. : actuel$^2$). Qui
...
\ib{Visée} — Mor. Orientation générale
...
\ib{Vision en Dieu} — A Hist. Chez Male
...
\ib{Vital} — 1. Qui se rapporte à la vie.
...
\ib{Vitalisme} — A. Biol. 1. (Opp. : animisme$^2$ et mécanisme$^3$). Théorie biologique (de Barthez, J. Grasset)
...
\ib{Volition} — Psycho. @ Acte de volonté$^1$ :
« Vouloir, c’est agir : la volition est
un passage à l'acte » (Ribot).

\ib{Volontarisme} — A. Méta. 4, Système
...
\ib{Volonté} — Psycho. Str. 1. O. Forme
...
\ib{Vrai} — Crit. 1. Qui mérite l’assentiment* : « Ne recevoir jamais aucune
...
\ib{Weltanschauung} — Méta. Mot alle
...
\ib{Zermelo (Axiome de)} — Épist. Postulat logique (dit encore axiome de
