...
\ib{Eccéité} — [L. {\it ecce}, voici] — \si{Méta.} {\it Dans
...
\ib{Émanation} — \si{Méta.} {\bf 1.} {\it Str.} (Opp. :
...
\ib{Énergétisme} — \si{Méta.} \fsb{S. norma.} La théorie
...
\ib{Erreur} — \si{Épist.} {\bf 1.} \fsb{S. abstr.} Action de se
...
\ib{Exemplarisme} — \si{Hist.} \fsb{S. norma.} Doctrine
...
\ib{Existant} — \si{Méta.} {\bf 1.} \fsb{S. objec.} (Nom neutre).
...
\ib{Existentiel} — \si{Méta.} {\bf 1.} \fsb{S. objec.} Qui implique
...
(Gusdorf). — {\bf 2.} \fsb{S. concr.} (\si{Vulg.}) Connaissance par l'expérience$^1$ et l'usage
de la vie : « L'expérience se forme
avec l’âge » (Saint-Evremond).

{\bf B)} \fsb{S. objec.} Expérience élaborée. ({\it Adj.}
corresp. : {\it expérimental}*). {\bf 3.} \fsb{S. abstr.} Connaissance par
...
\ib{Expérimental} — \si{Épist.} {\bf 1.} {\it Str.} Qui
...
\ib{Extensif} — \si{Épist.} Se dit des grandeurs qui peuvent se représenter par
